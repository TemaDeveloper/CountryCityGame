...
public class AdapterMediumLvl extends RecyclerView.Adapter<AdapterMediumLvl.LightLvlViewHolder> {

    private ArrayList<ItemLvl> lvls;
    private Context context;

    public AdapterMediumLvl(Context context, ArrayList<ItemLvl> lvls) {
        this.lvls = lvls;
    ...
    @NonNull
    @Override
    public AdapterMediumLvl.LightLvlViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_lvl_medium, parent, false);
        return new AdapterMediumLvl.LightLvlViewHolder(view);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull AdapterMediumLvl.LightLvlViewHolder holder, int position) {
        ...
        if(position > 0 && !lvls.get(position - 1).getScore().equals("0 / 10")){
            ...
            holder.textNum.setTextColor(ContextCompat.getColor(context, R.color.pink));
        ...
        public LightLvlViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.setClass(context, LVLMediumActivity.class);

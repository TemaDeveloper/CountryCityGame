...
import com_country_city.country_city_java.countrycitygame.LVLconstructors.InsaneLVLActivity;
import com_country_city.country_city_java.countrycitygame.LVLconstructors.LVLMediumActivity;
...
public class AdapterInsane extends RecyclerView.Adapter<AdapterInsane.InsaneLvlViewHolder> {

    private ArrayList<ItemLvl> lvls;
    private Context context;

    public AdapterInsane(Context context, ArrayList<ItemLvl> lvls) {
        this.lvls = lvls;
    ...
    @NonNull
    @Override
    public AdapterInsane.InsaneLvlViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_lvl_medium, parent, false);
        return new AdapterInsane.InsaneLvlViewHolder(view);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(@NonNull AdapterInsane.InsaneLvlViewHolder holder, int position) {
        ...
        if(position > 0 && !lvls.get(position - 1).getScore().equals("0 / 10")){
            ...
            holder.textNum.setTextColor(ContextCompat.getColor(context, R.color.orange));
    ...
    public class InsaneLvlViewHolder extends RecyclerView.ViewHolder {

        private TextView textNum, textScore;
        private ImageView imgCircle;
        private CardView cardLvl;

        public InsaneLvlViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.setClass(context, InsaneLVLActivity.class);

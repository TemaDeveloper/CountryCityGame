...
public class InsaneLVLsActivity extends AppCompatActivity implements buildRecyclerView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insane_lvls);
    ...
    private void init() {
        ...
        lvlModel.recyclerViewLightLvls = findViewById(R.id.recyclerView_insane_lvls);
